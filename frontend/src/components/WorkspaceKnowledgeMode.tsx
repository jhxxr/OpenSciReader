...
export interface WorkspaceKnowledgeModeProps {
...
export function WorkspaceKnowledgeMode({
  ...
  return (
    <section className="workspace-tab">
      <div className="workspace-tab-hero workspace-tab-hero-knowledge">
        <div>
            ...
            <div className="section-header workspace-panel-header">
              ...
              <div className="workspace-panel-header-actions home-workspace-actions home-workspace-actions-stacked">
                <div className="wiki-model-selector">
                  ...
                  >
                    {!selectedProviderConfig ? <option value={0}>Select model</option> : null}
